...
namespace ice::input
{
    ...
    public:
        ...
        //struct Iterator
        //{
        //    ice::Array<DeviceEvent> const* _queue;
        //    ice::Data _data;
        //    ice::u32 _index = 0;
        ...
        //        Data current_data;
        //        current_data.alignment = ice::ualign::b_4;
        //        current_data.location = ice::ptr_add(_data.location, { _data_offset });
        //        current_data.size = { ice::usize::base_type(current_event.payload.size * current_event.payload.count) };
        //        _data_offset += current_data.size.value;
        //        if ((_data_offset % 4) != 0)
        //        {
