...
namespace ice
{
    ...
    {
        // We move shards from the end of the array to the locations we want to remove.
        //   Finally, we resize the array ensuring the tail values are no longer accessed.
