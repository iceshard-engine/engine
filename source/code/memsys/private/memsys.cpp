...
//mem::utils::allocator_category::allocator_category(const char* category)
//{
//    size_t length = std::min(s_BufferSize - 1, strlen(category));
//    memcpy(m_Buffer, category, length);
//    m_Buffer[length] = 0;
//}
//
//mem::utils::allocation_list::allocation_list(allocator& alloc, size_t initial_size) : m_Allocator(alloc), m_Size(initial_size), m_Count(0), m_List(nullptr)
//{
//    m_List = reinterpret_cast<entry*>(m_Allocator.allocate(sizeof(entry) * m_Size, 8));
//    memset(m_List, 0, sizeof(entry) * m_Size);
//}
//
//mem::utils::allocation_list::~allocation_list()
//{
//    m_Allocator.deallocate(m_List);
//}
//
//void mem::utils::allocation_list::set(void* ptr, size_t size)
//{
//    if (m_Count == m_Size)
//        grow();
//}
//
//size_t mem::utils::allocation_list::get(void* ptr)
//{
//    entry* it = m_List;
//    entry* end = m_List + m_Count;
//    while (it != end && it->ptr != ptr)
//        ++it;
//    return it->size;
//}
//
//size_t mem::utils::allocation_list::unset(void* ptr)
//{
//    size_t old_value;
//    if (m_Count > 1)
//    {
...
//    }
//    else
//        old_value = m_List->size;
//    --m_Count;
//    return old_value;
//}
//
//void mem::utils::allocation_list::grow()
//{
//    size_t new_size = m_Size * 2;
//
//    // Create and copy
//    entry* new_list = reinterpret_cast<entry*>(m_Allocator.allocate(sizeof(entry) * new_size, 8));
//    memset(new_list, 0, sizeof(entry) * new_size);
//    memcpy(new_list, m_List, sizeof(entry) * m_Size);
//
//    // Free and replace
//    m_Allocator.deallocate(m_List);
//    m_List = new_list;
