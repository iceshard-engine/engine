...
*/
    ...
    #define CUSTOM_ERROR_ACCTION_CODE(c) c
    ...
    #ifndef CUSTOM_ERROR_ACCTION_CODE
        #define CUSTOM_ERROR_ACCTION_CODE(c)
    #endif // CUSTOM_ERROR_ACCTION_CODE
...
void* malloc_state::sys_alloc(size_t nb) {
    ...
    */
    ...
    if constexpr (MORECORE_CONTIGUOUS && !use_noncontiguous()) {
        char* br = CMFAIL;
    ...
    if constexpr (HAVE_MORECORE && tbase == CMFAIL) {
...
void* malloc_state::tmalloc_small(size_t nb) {
    ...
    CORRUPTION_ERROR_ACTION(this);
    CUSTOM_ERROR_ACCTION_CODE(return 0;)
}
