...
namespace ice::ecs
{
    ...
    template<typename T> requires Component<T> || IsEntityHandle<T> || IsEntity<T>
    ...
    template<>
    constexpr inline ice::StringID Constant_ComponentIdentifier<ice::ecs::EntityHandle> = "ice.__ecs_entity_handle__"_sid;
