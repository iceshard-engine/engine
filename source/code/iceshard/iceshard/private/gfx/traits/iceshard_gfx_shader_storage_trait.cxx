...
namespace ice::gfx
{
    ...
    void Trait_GfxShaderStorage::gather_tasks(ice::TraitTaskLauncher& task_launcher) noexcept
    {
        task_launcher.bind<&Trait_GfxShaderStorage::gfx_update>(ice::gfx::ShardID_GfxFrameUpdate);
        task_launcher.bind<&Trait_GfxShaderStorage::gfx_shutdown>(ice::gfx::ShardID_GfxShutdown);
    }
