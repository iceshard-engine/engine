...
namespace iceshard
{
    ...
    bool IceshardServiceProvider::has_component_system(core::cexpr::stringid_argument_type component_system_name) const noexcept
    {
        return core::pod::hash::has(_world_component_systems, static_cast<uint64_t>(component_system_name.hash_value));
    }

    auto IceshardServiceProvider::component_system(core::cexpr::stringid_argument_type component_system_name) noexcept -> ComponentSystem*
    {
    ...
    auto IceshardServiceProvider::component_system(core::cexpr::stringid_argument_type component_system_name) const noexcept -> const ComponentSystem*
    {
        const auto component_system_hash = static_cast<uint64_t>(component_system_name.hash_value);
