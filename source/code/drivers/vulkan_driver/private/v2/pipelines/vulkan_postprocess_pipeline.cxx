#include "vulkan_postprocess_pipeline.hxx"
#include <core/allocators/stack_allocator.hxx>

namespace iceshard::renderer::vulkan
{

    void query_postprocess_vertex_input_descriptions(
    ...
    ) noexcept
    {
        ...
        core::pod::array::resize(attributes, 2);
    ...
    ) noexcept
    {
        ...
        query_postprocess_vertex_input_descriptions(
