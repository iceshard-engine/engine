...
namespace iceshard::renderer::vulkan
{
    ...
    void query_debugui_vertex_input_descriptions(
    ...
    ) noexcept
    {
        ...
        query_debugui_vertex_input_descriptions(
        ...
        rs.cullMode = VK_CULL_MODE_NONE; // Specific to DebugUI
