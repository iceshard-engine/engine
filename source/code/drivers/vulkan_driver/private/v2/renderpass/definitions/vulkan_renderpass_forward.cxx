...
namespace iceshard::renderer::vulkan
{
    ...
    auto create_renderpass<RenderPassType::ForwardPostProcess>(VkDevice device, VkFormat attachment_format) noexcept -> VkRenderPass
    {
        ...
        references[1].layout = VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL;
        references[2].attachment = 2;
        references[2].layout = VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL;
        ...
        subpasses[0].pDepthStencilAttachment = references + 2;
        ...
        subpasses[1].pColorAttachments = references + 1;
        subpasses[1].pResolveAttachments = nullptr;
        subpasses[1].pDepthStencilAttachment = references + 2;
