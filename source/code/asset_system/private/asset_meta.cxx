...
namespace asset
{
    namespace detail
    {
        ...
        auto get_entry(AssetMetaView const& meta, core::cexpr::stringid_argument_type key, MetaEntryType expected_type) noexcept -> MetaEntry
        {
            auto entry = core::pod::hash::get(meta._meta_entries, static_cast<uint64_t>(key.hash_value), asset::detail::MetaEntry{});
    ...
    AssetMeta::AssetMeta(core::allocator& alloc) noexcept
        : _meta_entries{ alloc }
    ...
    {
        AssetMetaView result_meta{ { core::memory::globals::null_allocator() } };
