...
namespace ice::platform
{
    ...
    struct StoragePaths
    {
        ...
        virtual auto data_locations() const noexcept -> ice::Span<ice::Path const> = 0;
        ...
        virtual auto usercontent_location(UserContentType content_type) const noexcept -> ice::Path
        {
        ...
        virtual auto dylibs_location() const noexcept -> ice::Path = 0;
    };
