...
namespace ice::platform::linux
{
    ...
    class LinuxStorage final : public ice::platform::StoragePaths
    {
    public:
        LinuxStorage(ice::Allocator& alloc, ice::Span<ice::Shard const> params) noexcept;
